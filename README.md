...
- **`listing-audit`** — Paste any listing URL (Zillow, Realtor, Redfin, MLS) or address. Get a strategic audit report and an optional redesigned listing page.
- **`listing-copy`** — Turn property facts into MLS remarks, a long description, social variants (X / Instagram / Facebook), and an email blast. Tunable to the agent's voice and a property-tone preset (luxury, starter-home, investor, fixer, land).
- **`buyer-seller-comms`** — Templates + on-demand generation for the recurring agent comms loop: buyer drips, seller updates, offer summaries, follow-ups, referral asks. SMS / email / voicemail variants.
